...
class PromoCodeController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'uses_per_user' => 'nullable',
            'from' => 'required|date_format:Y-m-d',
            'to' => 'required|date_format:Y-m-d|after:from',
            'promo_type' => 'required',
            "sequential_times" => 'nullable',
            'discount_sequential' => 'nullable|array',
        ]);
        ...
        $created_params = $request->only(['code', 'minimum_trip_amount', 'maximum_discount_amount', 'discount_percent', 'total_uses', 'uses_per_user', 'promo_code_users_availabe', 'promo_type', 'sequential_times', 'discount_sequential']);



        if (is_null($created_params['uses_per_user'])) {
    ...
    public function update(UpdatePromoRequest $request, Promo $promo)
    {
        ...
        $created_params = $request->only(['module', 'code', 'minimum_trip_amount', 'maximum_discount_amount', 'discount_percent', 'total_uses', 'uses_per_user', 'transport_type', 'promo_code_users_availabe', 'promo_type', 'sequential_times', 'discount_sequential']);
