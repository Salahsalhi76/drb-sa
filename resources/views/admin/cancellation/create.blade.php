                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_type" id="payment_type" class="form-control" required>
                                                <option value="" selected disabled>@lang('view_pages.select')</option>
                                                <option value="free"
                                                    {{ old('payment_type') == 'free' ? 'selected' : '' }}>@lang('view_pages.free')
                                                </option>
                                                <option value="compensate"
                                                    {{ old('payment_type') == 'compensate' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="arrival_status" id="arrival_status" class="form-control" required>
                                                <option value="" selected disabled>@lang('view_pages.select')</option>
                                                <option value="before"
                                                    {{ old('arrival_status') == 'before' ? 'selected' : '' }}>
                                                    @lang('view_pages.before')</option>
                                                <option value="after"
                                                    {{ old('arrival_status') == 'after' ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cancellation_type" id="cancellation_type" class="form-control"
                                                ...
                                                <option value="before_driver_accept_ride"
                                                    {{ old('cancellation_type') == 'before_driver_accept_ride' ? 'selected' : '' }}>
                                                    Before Driver Accept Ride </option>
                                                <option value="after_driver_accept_ride"
                                                    {{ old('cancellation_type') == 'after_driver_accept_ride' ? 'selected' : '' }}>
