                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($result->complaint_type == 'request_help')
                                            <span class="badge badge-warning">@lang('view_pages.trip_complaint')</span>
                                        @else
                                    ...
                                    <td>
                                        <a class="text-primary"
                                            href="/driver_profile_dashboard_view/{{ $result->driver->id }}">
                                            {{ $result->driver->name }}
                                        </a>
                                    </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @endif
                                                    @if ($result->request_id && ($request = \App\Models\Request\Request::find($result->request_id)))
                                                        @php
                                                            $url = $request->is_cancelled
                                                                ? url('requests/cancelled', $request->id)
                                                                : url('requests', $request->id);
                                                        @endphp
                                                        <a class="dropdown-item" href="{{ $url }}">
                                                            <i class="fa fa-dot-circle-o"></i> Trip Details
                                                        </a>
                                                    @endif
                                                </div>
                                            </div>
