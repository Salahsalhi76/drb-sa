    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if (auth()->user()->can('access-dashboard'))
                ...
                <li class="{{ 'wasel/get-drivers' == $main_menu ? 'active' : '' }}">
                    <a href="{{ route('wasel.get-drivers') }}">
                        <i class="fa fa-solid fa-id-card"></i> <span>Wasel Drivers</span>
                    </a>
                </li>
                <li class="{{ 'wasel/get-trips' == $main_menu ? 'active' : '' }}">
                    <a href="{{ route('wasel.get-trips') }}">
                        <i class="fa fa-solid fa-taxi"></i>
                        <span>Wasel Trips</span>
                    </a>
                </li>
            @endif
                        ...
                        @if (auth()->user()->can('view-system-settings'))
                            <li class="{{ 'system_settings' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/system/settings') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.system_settings')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('map-settings'))
                            <li class="{{ 'translations' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/system/settings/map') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.map_settings')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('sms-settings'))
                            <li class="{{ 'translations' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/system/settings/sms_gateway') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.sms_settings')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('view-translations'))
                            <li class="{{ 'translations' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/translations') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.translations')</a>
                            </li>
                        @endif

                        @if (auth()->user()->can('onboarding-screen'))
                            <li class="{{ 'onboarding' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/system/settings/onboarding') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.onboarding_screen')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('invoicecms'))
                            <li class="{{ 'cms_invoice' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/cms/invoicecms') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.invoice_cms')</a>
                            </li>
                        @endif
...
@endif   -->
                        ...
                        @if (auth()->user()->can('manage-goods-types') && $app_for !== 'taxi')
                            <li class="{{ 'goods_type' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/goods-types') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.goods_types')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('package-type'))
                            <li class="{{ 'package_type' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/package_type') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.package_type')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('banner_image'))
                            <li class="{{ 'banner_image' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/banner_image') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.banner_image')</a>
                            </li>
                        @endif
                    ...
                    <ul class="treeview-menu">
                        @foreach ($areas as $item)
                            <li class="{{ $sub_menu == $item->name ? 'active' : '' }}" data-id="{{ $item->id }}">
                                <a href="{{ url('/owners/by_area', $item->id) }}"><i
                                        class="fa fa-circle-thin"></i>{{ ucfirst($item->name) }}</a>
                            </li>
                        @endforeach
                    </ul>
                ...
                <li class="treeview {{ 'vehicle-fare' == $main_menu ? 'active menu-open' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        @foreach ($zones as $item)
                            <li class="{{ $sub_menu == $item->name ? 'active' : '' }}"
                                data-id="{{ $item->id }}">
                                <a href="{{ url('/vehicle_fare/by_zone', $item->id) }}"><i
                                        class="fa fa-circle-thin"></i>{{ ucfirst($item->name) }}</a>
                            </li>
                        @endforeach
                    </ul>
                ...
                <li class="treeview {{ 'fleet-drivers' == $main_menu ? 'active menu-open' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if (auth()->user()->can('fleet-drivers-waiting-for-approval'))
                            <li class="{{ 'driver_approval_pending' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/fleet-drivers/waiting-for-approval') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.pending_approvals')</a>
                            </li>
                        @endif
                    </ul>
                    ...
                    <ul class="treeview-menu">
                        @if (auth()->user()->can('view-users'))
                            <li class="{{ 'user_details' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/users') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.user_details')</a>
                            </li>
                        @endif
                        @if (auth()->user()->can('view-delete-users'))
                            <li class="{{ 'user_details' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/users/deleted') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.deleted_users')</a>
                            </li>
                        @endif
                    </ul>
                </li>
            ...
            @if (auth()->user()->can('access-live-chat'))
            ...
            <li class="{{ 'manage-offers' == $main_menu ? 'active' : '' }}">
                <a href="{{ url('/offers') }}">
                    ...
                    <ul class="treeview-menu">
                        @if (auth()->user()->can('complaint-title'))
                            <li class="{{ 'complaint-title' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/complaint/title') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.complaint_title')</a>
                            </li>
                        @endif
                            ...
                            <li class="treeview {{ 'user-complaint' == $sub_menu ? 'active' : '' }}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="{{ 'user-request-complaint' == $sub_menu ? 'active' : '' }}">
                                        <a href="{{ url('/complaint/users/request') }}">@lang('pages_names.request_complaints')</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                            ...
                            <li class="treeview {{ 'driver-complaint' == $sub_menu ? 'active' : '' }}">
                                ...
                                <ul class="treeview-menu">
                                    <li class="{{ 'driver-general-complaint' == $sub_menu ? 'active' : '' }}">
                                        <a href="{{ url('/complaint/drivers/general') }}">@lang('pages_names.general_complaints')</a>
                                    </li>

                                    <li class="{{ 'driver-request-complaint' == $sub_menu ? 'active' : '' }}">
                                        <a href="{{ url('/complaint/drivers/request') }}">@lang('pages_names.request_complaints')</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                            ...
                            <li class="treeview {{ 'owner-complaint' == $sub_menu ? 'active' : '' }}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="{{ 'owner-request-complaint' == $sub_menu ? 'active' : '' }}">
                                        <a href="{{ url('/complaint/owner/request') }}">@lang('pages_names.request_complaints')</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                    ...
                    <ul class="treeview-menu">
                        @if (auth()->user()->can('user-report'))
                            <li class="{{ 'user_report' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/reports/user') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.user_report')</a>
                            </li>
                        @endif

                        @if (auth()->user()->can('driver-report'))
                            <li class="{{ 'driver_report' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/reports/driver') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.driver_report')</a>
                            </li>
                        @endif
            ...
            <a href="{{ url('/reports/driver-duties') }}"><i class="fa fa-circle-thin"></i>@lang('pages_names.driver_duties_report')</a>
                        ...
                        @if (auth()->user()->can('owner-report'))
                            <li class="{{ 'owner_report' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/reports/owner') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.owner_report')</a>
                            </li>
                        @endif

                        @if (auth()->user()->can('finance-report'))
                            <li class="{{ 'finance_report' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('/reports/travel') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.finance_report')</a>
                            </li>
                        @endif
                    </ul>
                </li>
                    ...
                    <ul class="treeview-menu">
                        @if (auth()->user()->can('heat-map'))
                            <li class="{{ 'heat_map' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ url('map/heatmap') }}"><i
                                        class="fa fa-circle-thin"></i>@lang('pages_names.heat_map')</a>
                            </li>
                        @endif

                        @if (auth()->user()->can('map-view'))
                            <li class="{{ 'map' == $sub_menu ? 'active' : '' }}">
                                <a href="{{ route('mapView') }}"><i
            ...
            @if (auth()->user()->can('cms'))
                ...
                <a href="{{url('/cms/webbookingcms')}}"><i class="fa fa-circle-thin"></i>@lang('pages_names.web_booking_cms')</a>
                        ...
                        <li class="{{ 'cms_frontpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/frontpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.home_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_safetypage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/safetypagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.safety_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_servicepage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/servicepage') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.services_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_privacypage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/privacypagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.privacy_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_dmvpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/dmvpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.dmv_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_complaincepage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/complaincepagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.complaince_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_termspage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/termspagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.terms_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_drreqpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/drreqpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.driver_req_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_applydriverpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/applydriverpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.apply_to_drive')</a>
                        </li>
                        <li class="{{ 'cms_howdriverpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/howdriverpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.how_it_works_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_contactpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/contactpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.contact_us_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_playstorepage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/playstorepagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.playstore_link_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_footerpage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/footerpagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.footer_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_colorthemepage' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/colorthemepagecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.color_theme_page_cms')</a>
                        </li>
                        <li class="{{ 'cms_invoice' == $sub_menu ? 'active' : '' }}">
                            <a href="{{ url('/cms/invoicecms') }}"><i
                                    class="fa fa-circle-thin"></i>@lang('pages_names.invoice_cms')</a>
