    ...
    <div class="container-fluid text-white">
      <div class="row pt-md doot">
        ...
        <div class="col-lg-2 col-sm-4 ml-lg-auto mb-5 mb-lg-0">
          ...
          <h6 class="heading ml-n5 mb-3">روابط سريعة </h6>
          <ul class="list-unstyled">
            <li><a href="{{ url('/') }}" class="text-white opacity-80">الرئيسية
</a></li>
            <li><a href="{{ url('serviceareas') }}" class="text-white opacity-80">مواقع الخدمة</a></li>
            <li><a href="{{ url('compliance') }}" class="text-white opacity-80">الأمتثال </a></li>
            <li><a href="{{ url('contactus') }}" class="text-white opacity-80">تواصل معنا</a></li>
            <li><a href="{{ url('privacy') }}" class="text-white opacity-80">سياسة الخصوصية</a></li>
            <li><a href="{{ url('terms') }}" class="text-white opacity-80">الشروط والاحكام</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-sm-4 mb-5 mb-lg-0">
          <h6 class="heading ml-n5 mb-3">الراكب</h6>
          <ul class="list-unstyled">
            <!-- <li><a href="#" class="text-white opacity-80">How it works</a></li>
            <li><a href="#" class="text-white opacity-80">Rider Requirements</a></li> -->
            <li><a href="{{ url('safety') }}" class="text-white opacity-80">السلامة</a></li>
          </ul>
          <div class="row">
        ...
        <div class="col-lg-2 col-md-4 mb-5 mb-lg-0">
          <h6 class="heading ml-n5 mb-3">الكباتن</h6>
          <ul class="list-unstyled text-small">
            <li><a href="{{ url('howdriving') }}" class="text-white opacity-80">كيف نعمل</a></li>
            <li><a href="{{ url('driverrequirements') }}" class="text-white opacity-80">متطلبات الكابتن</a></li>
