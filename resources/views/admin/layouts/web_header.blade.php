      ...
      <div class="collapse navbar-collapse order-md-3" id="navbarLandingCollapse">
        ...
        <ul class="navbar-nav nav-divided ml-auto">
          ...
          <li class="nav-item dn-2">
            <a class="nav-link home" style="color:{{ $data->menutextcolor }} !important;" href="{{ url('/') }}">الرئيسية
</a>
          </li>
          <li class="nav-item dropdown">
  
            <a class="nav-link driver" style="color:{{ $data->menutextcolor }} !important;" data-toggle="dropdown" href="#">الكابتن</a>
          ...
          <li class="nav-item">
            <a class="nav-link areas"  style="color:{{ $data->menutextcolor }} !important;" href="{{ url('serviceareas') }}">مواقع خدماتنا</a>
          </li>
          <!-- <li class="nav-item dropdown">
