            ...
            <ul style="font-size:18px;margin-top:20px;">
              ...
              <li><strong>Admin panel works with only using by google map API.</strong></li>
                ...
                @php
                    $id = $item[0]->id;
                @endphp
                <form method="post" class="form-horizontal" action="{{ url('system/settings/map/store') }}"
                    ...
                    <div class="row mt-10 p-5">
                        ...
                        <div class="col-12 col-lg-4">
                            <label class="radio-img">
                                <input type="radio" name="map_type" value="google"
                                    {{ $item[0]->value == 'google' ? 'checked' : '' }} checked />
                        ...
                        <div class="col-12 col-lg-4">
                            <label class="radio-img">
                                <input type="radio" name="map_type" value="open_street"
                                    {{ $item[0]->value == 'open_street' ? 'checked' : '' }} />
