                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('offers/update', $item->id) }}">
                                @csrf
                                            ...
                                            <select name="service_location_id" id="service_location_id"
                                                ...
                                                @foreach ($cities as $city)
                                                    <option value="{{ $city->id }}"
                                                        {{ old('service_location_id', $item->service_location_id) === $city->id ? 'selected' : '' }}>
                                                        {{ $city->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="request_number" name="request_number"
                                                value="{{ old('request_number', $item->request_number) }}" required
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="datetime-local" id="from_date"
                                                name="from_date" value="{{ old('from_date', $item->from_date) }}" required
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="datetime-local" id="to"
                                                name="to_date" value="{{ old('to_date', $item->to_date) }}" required=""
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="earning_price" name="earning_price"
                                                value="{{ old('earning_price', $item->earning_price) }}" required
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" type="number" id="subject" name="subject"
                                                ...
                                                placeholder="Subject Of Offer">{{ old('subject', $item->subject) }}</textarea>
