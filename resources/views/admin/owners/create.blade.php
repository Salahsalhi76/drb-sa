                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 pb-3">
                            ...
                            @if ($item->has_expiry_date)
                                @php
                                    $expiryDates = old('expiry_date', [now()->startOfMonth()->format('Y-m-d')]); // Default to current month start date if no old values
                                @endphp
                                ...
                                @foreach ($identifyNumbers as $index => $identifyNumber)
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="identify_number[]" placeholder="{{ $item->identify_number_locale_key }}">
                                        </div>
                                    </div>
                                @endforeach
                            @endif
