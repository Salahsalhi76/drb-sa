                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('promo/store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="admin_id">Promo Type
                                                <span class="text-danger">*</span>
                                            </label>
                                            <select name="promo_type[]" id="promo_type" class="form-control select2"
                                                data-placeholder="Promo Types">
                                                <option value="">Promo Type</option>
                                                <option value="squential"
                                                    {{ in_array($city->id, 'squential') ? 'selected' : '' }}>
                                                    Squential
                                                </option>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select name="transport_type" id="transport_type" class="form-control" required>
                                                ...
                                                <option value="taxi"
                                                    {{ old('transport_type') == 'taxi' ? 'selected' : '' }}>
                                                    @lang('view_pages.taxi')</option>
                                                <option value="delivery"
                                                    {{ old('transport_type') == 'delivery' ? 'selected' : '' }}>
                                                    @lang('view_pages.delivery')</option>
                                                <option value="both"
                                                    {{ old('transport_type') == 'both' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="minimum_trip_amount"
                                                name="minimum_trip_amount" value="{{ old('minimum_trip_amount') }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="uses_per_user">@lang('view_pages.uses_per_user') <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control" type="number" id="uses_per_user"
                                                name="uses_per_user" value="{{ old('uses_per_user') }}" required=""
