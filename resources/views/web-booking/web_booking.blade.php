         ...
         <div class="login-page">
            <div class="otp-number">
               <div class="verify-otps" style="display:none">
                <div><img class="logo" alt="Superbidding Logo" src="{{app_logo() ?? asset('images/email/logo1.jpeg')}}"></div>
               ...
               <div class="otp-design" method="post">
                  <form id="Adduser" >
                     ...
                     {{-- <div><img class="logo" alt="Superbidding Logo" src="{{web_booking_logo()}}"></div> --}}
                     ...
                     {{-- <div class="name-opt" style="text-align: left; margin-top: 15px; opacity: 0.7;">Select the Country</div>
                     <div class="intel-input" style="margin-top: 8px;opacity: 0.7;">
                         <select id="countrySelect" name="country" style="height: 100%;width: 311px;opacity: 0.7;"></select>
                     </div> --}}
                     ...
                     <div class="text opt-text-button">
         ...
         <div class="detail-engine-data">
            <div class="detail-engine">
               <div class="nav-list">
                  ...
                  @if($modules !== "taxi")
                  <div class="nav-tab">
                     <a class="item-name out_station @if($modules == 'delivery') actv @endif" data-val="delivery"> @lang('view_pages.delivery')</a>
               ...
               <div class="book-details">
                  ...
                  <div class="to-container">
                     ...
                     <!--   <div class="from-details out_station" style="display: none;">
                        ...
                        @if($modules !== 'taxi' && $modules !== 'delivery')
...
document.addEventListener('DOMContentLoaded', function() {
        fetch('{{ url("/") }}/api/v1/countries')
            ...
            .then(data => {
                ...
                option.dataset.flag = `/images/country/flags/${country.code}.png`;
