...
use App\Http\Controllers\WaselController;
/*
|--------------------------------------------------------------------------
| SPA Auth Routes
|--------------------------------------------------------------------------
...
use App\Http\Controllers\Web\Admin\offersController;
...
Route::middleware('auth:web')->group(function () {
    ...
    Route::namespace('Admin')->group(function () {
        ...
        Route::get('/wasel/driver/{id}', [WaselController::class, 'registerDriver'])->name('wasel.driver');
        Route::post('/wasel/driver/{id}', [WaselController::class, 'storeDriverAndVehicule'])->name('wasel.driver.store');
        Route::get('/wasel/get-drivers', [WaselController::class, 'driversIndex'])->name('wasel.get-drivers');
        Route::get('/wasel/trip', [WaselController::class, 'storeTripe']);
        Route::get('/wasel/get-trips', [WaselController::class, 'getTrips'])->name('wasel.get-trips');
    });
    // });
    ...
    Route::namespace('Admin')->group(function () {
        ...
        Route::group(['prefix' => 'users',  'middleware' => 'permission:user-menu'], function () {
            ...
            Route::get('details/{user}', 'UserController@details')->name('users.details');
        ...
        Route::group(['prefix' => 'offers'], function() {
            ...
            Route::get('/fetch', [offersController::class, 'fetch']);
            Route::get('/create', [offersController::class, 'create']);
            Route::post('store', [offersController::class, 'store']);
            Route::get('/{offer}', [offersController::class, 'getById']);
            Route::post('update/{offer}', [offersController::class, 'update']);
            Route::get('toggle_status/{offer}', [offersController::class, 'toggleStatus']);
            Route::get('delete/{offer}', [offersController::class, 'delete']);
        });
